...
#   - from a terminal:  Rscript TAXI/build_taxi_dashboard.R
#   - from RStudio:     source(here::here("TAXI", "build_taxi_dashboard.R"))
...
html_file <- here::here("index.html")
...
readr::write_file(
  paste0("// Generated by build_taxi_dashboard.R — do not edit by hand.\n",
         "// Rebuild with: Rscript TAXI/build_taxi_dashboard.R\n",
