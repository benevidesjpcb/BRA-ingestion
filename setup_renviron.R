...
RENVIRON_VARS <- list(
  ...
  list(name = "CGNA_TOTALBR_URL", value = "",
       note = c("Optional: the CGNA endpoint serving the national flight table.",
                "Defaults to https://portal.cgna.decea.mil.br/apiv1/voossisceab;",
                "set it only if that path is renamed. Uses TATIC_TOKEN.")),
  list(name = "CGNA_TOTALBR_PAGE_SIZE", value = "1000",
