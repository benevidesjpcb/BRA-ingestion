...
RENVIRON_VARS <- list(
  ...
  list(name = "ODIN_TOKEN", value = "",
       note = c("Not needed today: the ODIN API is open. Kept here for the day",
                "it is not.")),
  list(name = "ODIN_PROXY", value = "",
       note = c("Corporate proxy, e.g. http://proxy.example.int:8080. Only needed",
